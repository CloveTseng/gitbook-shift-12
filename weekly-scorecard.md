...
| 預計關鍵行動 / 策略                                                               | 實際執行                                                                                                                                                                                                                             | 說明                                                                                                                      |
| ------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| 了解公司文化與組織架構                                                               | <ul class="contains-task-list"><li><input type="checkbox" checked>搞清楚「誰是誰」</li><li><input type="checkbox" checked>了解同步溝通頻率</li><li><input type="checkbox" checked>閱讀內部文件</li><li><input type="checkbox" checked>了解公司產品</li></ul> | <p>是沒有交接文件或是內部文件，但主管是走扁平化管理，大家有意見都隨時可以提出討論<br>主管是很 I 的工程師，完全都不講話的 z 哥那種類型，應該說整個部門都是 I 到爆<br>比較熟悉了一點點公司目前正在跑的產品跟開發習慣</p> |
| 理解公司技術架構與開發流程                                                             | 看了一些公司的專案，並且已經開始 fix/ 了一些簡單的小 bug                                                                                                                                                                                                |                                                                                                                         |
...
| 確保邵同學 YT 更新                                                               | 本週跟邵同學先討論更新計劃的方向與規劃，以及更新大綱                                                                                                                                                                                                       |                                                                                                                         |
